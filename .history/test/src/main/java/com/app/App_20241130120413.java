...
public class App 
{
    ...
    static  void startingOpenCL(String texto, String palavra){
       ...
       // Create buffers
       cl_mem textBuffer = clCreateBuffer(context, CL.CL_MEM_READ_ONLY | CL.CL_MEM_COPY_HOST_PTR, textBytes.length, Pointer.to(textBytes), null);
       cl_mem wordBuffer = clCreateBuffer(context, CL.CL_MEM_READ_ONLY | CL.CL_MEM_COPY_HOST_PTR, wordBytes.length, Pointer.to(wordBytes), null);
       ...
       // Output result
       System.out.println("The word '" + palavra + "' appears " + count[0] + " times in the text.");
